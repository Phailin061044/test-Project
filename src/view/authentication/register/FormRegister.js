                ...
                <div className="col-12 px-1 mb-1 mt-3">
                  <div className="row">
                    <div className="d-flex justify-content-left">
                      <h5 className="title-content">ข้อมูลทั่วไป</h5>
                    </div>
                    ...
                    <div className="col-12 px-1 mb-1 mt-3">
                    <div className="d-flex justify-content-left">
                      <h5 className="title-content">บุคคลที่ติดต่อได้</h5>
                    </div>
                    </div>
                    <div className="col-4 px-1 mt-2">
                      <div class="form-row mt-4">
                    ...
                    <div className="col-4 px-1 mt-2">
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          setFieldValue("contact_first_name", e.target.value);
                        }}
                      />
                      <ErrorMessage
                        component="div"
                    ...
                    <div className="col-4 px-1 mt-2">
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          setFieldValue("contact_last_name", e.target.value);
                        }}
                      />
                      <ErrorMessage
                        component="div"
                    ...
                    <div className="col-6 px-1 mt-2">
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          setFieldValue("contact_phoneNumber", e.target.value);
                        }}
                      />
                      <ErrorMessage
                        component="div"
                    ...
                    <div className="col-12 px-1 mb-1 mt-3">
                    <div className="d-flex justify-content-left">
                      <h5 className="title-content">ข้อมูลที่อยู่</h5>
                    </div>
                    </div>
                    <div className="col-6 px-1 mt-2">
                    ...
                    <div className="col-12 px-1 mb-1 mt-3">
                    <div className="d-flex justify-content-left">
                      <h5 className="title-content">ข้อมูลสุขภาพ</h5>
                    </div>
                    </div>
                    <div className="col-6 px-1 mt-2">
                      ...
                      >
                        ...
                        <option value="เส้นเลือดหัวใจตีบ">
                          เส้นเลือดหัวใจตีบ
                        </option>
                        <option value="เบาหวาน">เบาหวาน</option>
                        <option value="ไต">ไต</option>
                        <option value="ภูมิคุ้มกันบกพร่อง">
                          ภูมิคุ้มกันบกพร่อง
                        </option>
